...
<!--
This delta restates the baseline `openspec/specs/bottom-jokes/spec.md` contract
(adopted at G2) verbatim as ADDED requirements, for the record and so
`openspec validate add-bottom-jokes --strict` can validate the change against a
