...
const commands = [
  ...
  {
    // Service-integration over mocked Open-Meteo payloads (no DB — ADR-0003).
    name: "integration-tests",
    command: "npm",
    args: ["run", "test:integration"],
  },
  {
    // E2E is chrome-devtools MCP recordings (TC-STACK-05, no Playwright). The
    // test:e2e script is a non-failing, env-gated placeholder (ADR-0004) so the
    // battery never reports a browser pass that did not happen.
    name: "e2e",
    command: "npm",
    args: ["run", "test:e2e"],
  },
